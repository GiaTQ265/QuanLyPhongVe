		...
		<section class="wrapper">
			<div class="row" style="display: flex; justify-content: center">
				<div class="col-lg-4"
					...
					<br />
					<form:form action="${pageContext.request.contextPath }/admin/may-bay/save-may-bay" method="post"
						modelAttribute="maybay">
						<div class="row">
							<div class="form-group col-md-12">
								<label for="maMayBay">Mã máy bay</label>
								<form:input class="form-control" path="maMayBay" />
