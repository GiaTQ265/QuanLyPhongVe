				...
				<div class="col-md-12">
					<div class="content-panel">
						<table class="table table-striped table-advance table-hover">
							<h4>Doanh thu tháng theo tuyến bay</h4>
							<hr />
							<div style="float: right">
								<form
									action="${pageContext.request.contextPath}/admin/doanhThuTheoThang/timKiem"
									method="get">
							...
							<tbody>
								<c:forEach var="abc" items="${doanhThuTheoTuyenBays}"
									...
									<tr>
										...
										<td><a
											href="${pageContext.request.contextPath}/admin/doanhThuTheoThang/chiTiet/${abc.maTuyenBay}"><button
