		...
		<section class="wrapper">
			<div class="row" style="display: flex; justify-content: center">
				<div class="col-lg-4"
					...
					<br />
					<form:form
						action="${pageContext.request.contextPath}/admin/dich-vu/luu-dich-vu"
						...
						<div class="row">
							<div class="form-group col-md-12">
								...
								<form:input path="maDichVu" class="form-control" id="maDichVu"
									value="${maDichVu}" placeholder="${maDichVu}" />
								<small><form:errors path="maDichVu"></form:errors></small> <small
									id="checkid">${msg}</small>
							</div>
							<div class="form-group col-md-12">
						...
						<div class="form-group row">
							<div class="col-md-12" style="text-align: center">
								<button type="submit" class="btn btn-warning">Thêm dịch
									vụ</button>
							</div>
						</div>
					</form:form>
