			...
			<div class="row list">
				<div class="col-lg-4"
					...
					<form:form class="form"
						action="${pageContext.request.contextPath}/admin/loai-ve/chinh-sua"
						...
						<div class="row">
							...
							<div class="form-group col-md-12">
								...
								<small><form:errors path="heSoGia" /></small>
							</div>
						</div>
	...
	<script>
		...
		function validate() {
			...
			if (value.match(checkHeSo)) {
				...
				$("#heSoGiaE").show();
				$("#heSoGiaE").html(
						"<small>Vui lòng nhập đúng định dạng (là số > 0 và <= 5)</small>");
				return false;
			}
		}
	</script>	
