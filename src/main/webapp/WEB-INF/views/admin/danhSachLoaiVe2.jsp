				...
				<div class="col-lg-9">
					<div class="content-panel">
						...
						<div style="float: right">
							<form action="${pageContext.request.contextPath}/admin/loai-ve/tim-kiem"
								method="get">
						...
						<section>
									...
									<c:forEach var="c" items="${LoaiVe}" varStatus="status">
										<tr>
											...
											<td style="display: flex; justify-content: space-around"><a
												href="${pageContext.request.contextPath}/admin/loai-ve/chinh-sua/${c.maLoaiVe}"><button
														type="button" class="btn btn-info">Chỉnh sửa</button></a> <a
												href="${pageContext.request.contextPath}/admin/loai-ve/xoa-loai-ve/${c.maLoaiVe}"
							...
							<ul class="pagination" style="float: right;">
								<c:if test="${currentPage > 1}">
									<li><a
										href="${pageContext.request.contextPath}/admin/loai-ve/tim-kiem?searchKey=${key}&page=${currentPage-1}">Trang
											trước</a></li>
								</c:if>
								<c:forEach begin="1" end="${totalPages}" var="i">
									<c:choose>
										...
										<c:otherwise>
											<li><a href="${pageContext.request.contextPath}/admin/loai-ve/tim-kiem?searchKey=${key}&page=${i}">${i}</a></li>
										</c:otherwise>
									</c:choose>
								</c:forEach>
								<c:if test="${currentPage lt totalPages}">
									<li><a
										href="${pageContext.request.contextPath}/admin/loai-ve/tim-kiem?searchKey=${key}&page=${currentPage+1}">Tiếp
											theo</a></li>
								</c:if>
							</ul>
						</section>
