		...
		<section class="wrapper">
			...
			<div class="pagination">
				<c:if test="${currentPage > 1}">
					<a
						href="${pageContext.request.contextPath}/admin/doanhThuTheoThang/chiTiet/timKiem/${maTuyenBay}?page=${currentPage-1}&searchKey=${searchKeyPagination}">Previous</a>
				</c:if>
				<c:forEach begin="1" end="${totalPages}" var="i">
					<c:choose>
						...
						<c:otherwise>
							<a
								href="${pageContext.request.contextPath}/admin/doanhThuTheoThang/chiTiet/timKiem/${maTuyenBay}?page=${i}&searchKey=${searchKeyPagination}">${i}</a>
						</c:otherwise>
					</c:choose>
				</c:forEach>
				...
				<c:if test="${currentPage lt totalPages}">
					<a
						href="${pageContext.request.contextPath}/admin/doanhThuTheoThang/chiTiet/timKiem/${maTuyenBay}?page=${currentPage+1}&searchKey=${searchKeyPagination}">Next</a>
				</c:if>
			</div>
		</section>
	</section>
