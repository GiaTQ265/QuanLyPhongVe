...
<head>
<meta charset="UTF-8">
<title>Cập nhật chuyến bay</title>
		...
		<section class="wrapper">
			<div class="row list">
				<div class="col-lg-4"
					...
					<br />
					<form:form
						action="${pageContext.request.contextPath}/admin/chuyen-bay/cap-nhat?maTuyenBay=${maTuyenBay}&maMayBay=${maMayBay}"
						...
						<div class="row">
							...
							<div class="form-group col-md-12">
								...
								<form:input path="tuyenBay.maTuyenBay" id="maChuyenBay"
