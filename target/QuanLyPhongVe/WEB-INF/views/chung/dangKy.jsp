					...
					<div class="col-5">
						<div class="card" style="border-radius: 15px">
							<div class="card-body p-5">
								<form:form action="${pageContext.request.contextPath}/dangky"
									...
									<div class="form-outline mb-4">
										...
										<form:input path="matKhau" id="matKhau"
											class="form-control form-control-lg" type="password" style="${doiMau2}"/>
										<div style="color: red">
									...
									<div class="form-outline mb-4">
										...
										<input name="xacNhanMatKhau" type="password" id="form3Example4cdg"
											class="form-control form-control-lg" style="${doiMau3}"/>
											<p>${error3}</p>
									</div>

									<div class="form-check d-flex justify-content-center mb-5">
										<input class="form-check-input me-2" type="checkbox" value=""
											id="form2Example3cg" checked="checked"/>
										<label class="form-check-label"
											for="form2Example3g"> Tôi đồng ý với các điều khoản
											trong <a href="#!" class="text-body">Điều khoản dịch vụ</a>
										</label>
									</div>
									...
									<p class="text-center mt-5 mb-0" style="color: #026c84">
										Bạn đã có tài khoản? <a
											href="${pageContext.request.contextPath}/dangnhap"
