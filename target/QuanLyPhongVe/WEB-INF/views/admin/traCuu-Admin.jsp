		...
		<section class="wrapper">
			<div class="row" style="display: flex; justify-content: center;">
				<div class="col-lg-8"
					...
					<br />
					<form:form action="${pageContext.request.contextPath }/admin/timve" method="post" modelAttribute="timve">
						<div class="row">
							<div class="form-group col-md-6">
								<div class="form-group">
									<form:label path="tuyenBay.sanBayDi.maSanBay">Điểm đi</form:label>
									<form:select class="form-control"
										path="tuyenBay.sanBayDi.maSanBay" items="${listsb}"
										itemValue="maSanBay" itemLabel="diaDiem" />
									<form:errors path="${timve.tuyenBay.sanBayDi.maSanBay}" />
								</div>
							</div>
							<div class="form-group col-md-6">
								<div class="form-group">
									...
									<form:select class="form-control"
										path="tuyenBay.sanBayDen.maSanBay" items="${listsb}"
										itemValue="maSanBay" itemLabel="diaDiem" />
									<form:errors path="${timve.tuyenBay.sanBayDen.maSanBay}" />
								</div>
							</div>
						</div>
						<div class="row">
							...
							<div class="form-group col-md-6">
								<div class="form-group">
									...
									<form:select class="form-control" name="loaive" path=""
										items="${lvs}" itemValue="maLoaiVe" itemLabel="tenLoaiVe" />
