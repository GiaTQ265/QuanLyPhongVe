				...
				<div class="col-lg-9">
					<div class="content-panel">
						<div style="float: right">
							<form method="get"
								action="${pageContext.request.contextPath}/admin/dichvu/timkiemveban">
									...
									<c:forEach var="c" items="${dsVeDaBan}">
										<tr>
											...
											<td style="display: flex; justify-content: space-around">
												<a
												href="${pageContext.request.contextPath}/admin/dichvu/xoathanhtoan?maTTThanhToan=${c.maTTThanhToan}"><button
														type="submit" class="btn btn-danger">xóa</button></a> <a
												href="${pageContext.request.contextPath}/admin/dichvu/suathanhtoan?maTTThanhToan=${c.maTTThanhToan}"><button
							...
							<ul class="pagination" style="float: right">
								<c:if test="${currentPage > 1}">
									<li class="page-item"><a
										href="${pageContext.request.contextPath}/admin/dichvu/dsveban?page=${currentPage-1}">Previous</a></li>
								</c:if>
								<c:forEach begin="1" end="${totalPages}" var="i">
									<c:choose>
										...
										<c:otherwise>
											<li class="page-item"><a href="${pageContext.request.contextPath}/admin/dichvu/dsveban?page=${i}">${i}</a></li>
										</c:otherwise>
									</c:choose>
								</c:forEach>
