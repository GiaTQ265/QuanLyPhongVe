...
<style>
<%@ include file="/resources/assets/css/style.css"%></style>
<link
			...
			<security:authorize access="isAuthenticated()">
				<div class="top-menu">
					<ul class="nav pull-right top-menu">
						<li><a class="logout" href="<c:url value='/dangxuat'/>">Đăng
								xuất</a></li>
					</ul>
				</div>
			</security:authorize>
		...
		<aside>
			<div id="sidebar" class="nav-collapse">
				...
				<ul class="sidebar-menu" id="nav-accordion">
					<p class="centered">
						<img src="assets/img/airplane.jpg" class="img-circle" width="60" />
					</p>
					...
					<li class="sub-menu"><a> <i class="fa fa-desktop"></i> <span>Hỗ
						...
						<ul class="sub">
							...
							<li><a href="Hotro.html">Trang hỗ trợ</a></li>
						</ul></li>
				</ul>
				<!-- sidebar menu end-->
			</div>
